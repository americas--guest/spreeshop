...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			narrower:	{ range: '-840', href: 'assets/css/style-narrower.css', grid: { gutters: 20, collapse: 1 } },
			mobile:		{ range: '-640', href: 'assets/css/style-mobile.css', grid: { gutters: 15, collapse: 2 } }
		}
	}, {
		layers: {
			layers: {
