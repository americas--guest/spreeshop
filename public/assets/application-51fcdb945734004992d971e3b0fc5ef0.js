...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: 'vendor/assets/style.css.scss', containers: 1400, grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: 'vendor/assets/style-wide.css.scss', containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: 'vendor/assets/style-normal.css.scss', containers: 960, lockViewport: true },
			narrow:		{ range: '-980', href: 'vendor/assets/style-narrow.css.scss', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: 'vendor/assets/style-narrower.css.scss', grid: { gutters: 20, collapse: 1 } },
			mobile:		{ range: '-640', href: 'vendor/assets/style-mobile.css.scss', grid: { gutters: 15, collapse: 2 } }
		}
	}, {
		layers: {
			layers: {
