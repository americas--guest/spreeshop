...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: 'assets/spree/frontend/style.css', containers: 1400, grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: 'assets/spree/frontend/style-wide.css', containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: 'assets/spree/frontend/style-normal.css', containers: 960, lockViewport: true },
			narrow:		{ range: '-980', href: 'assets/spree/frontend/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: 'assets/spree/frontend/style-narrower.css', grid: { gutters: 20, collapse: 1 } },
			mobile:		{ range: '-640', href: 'assets/spree/frontend/style-mobile.css', grid: { gutters: 15, collapse: 2 } }
		}
	}, {
		layers: {
			layers: {
