...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			normal:		{ range: '-1280', href: 'assets/style-normal.css', containers: 960, lockViewport: true },
			narrow:		{ range: '-980', href: 'assets/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: 'assets/style-narrower.css', grid: { gutters: 20, collapse: 1 } },
			mobile:		{ range: '-640', href: 'assets/style-mobile.css', grid: { gutters: 15, collapse: 2 } }
		}
	}, {
		layers: {
			layers: {
